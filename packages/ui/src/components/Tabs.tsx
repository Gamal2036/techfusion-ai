...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-lg bg-surface-subtle p-1 text-text-muted',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=inactive]:hover:text-text-secondary data-[state=inactive]:hover:bg-surface-muted',
      className,
    )}
    {...props}
  />
