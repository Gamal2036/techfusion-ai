...
| Account profile (self-scoped summary + display name + MFA status + org context) | ✅ | ✅ | ✅ | — | — | ✅ | ✅ | ✅ | — | — | FREE | FUNCTIONAL | password change, avatar, session listing deferred (no backend); MFA is now fully interactive on the account page (enroll/disable/recovery codes) via `ACC-UX-02C` |
