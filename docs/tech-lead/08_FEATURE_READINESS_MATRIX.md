...
| Account profile (self-scoped summary + display name + MFA status + org context) | ✅ | ✅ | ✅ | — | — | ✅ | ✅ | ✅ | — | — | FREE | FUNCTIONAL | password change, avatar, session listing deferred (no backend); MFA status read-only (enroll/verify via auth flow) |
