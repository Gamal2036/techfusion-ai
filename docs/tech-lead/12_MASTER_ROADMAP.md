...
**V1-STAGE-01 remaining items (no new numbered substage): metrics token auth cleanup (S5 — move metrics token out of query string / require `METRICS_AUTH_TOKEN`), secrets hygiene review.**
