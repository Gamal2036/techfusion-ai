...
**V1-STAGE-01 remaining items (no new numbered substage): secrets hygiene review (final Stage-01 item); metrics token auth cleanup (S5 — move metrics token out of query string / require `METRICS_AUTH_TOKEN`) is a P2 follow-up.**
