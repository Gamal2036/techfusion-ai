  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-sm text-white/40 mt-1">Remote desktop and support session management.</p>
      </div>
      <GlassPanel intensity="light" className="p-12 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-lg font-medium text-white/50">Remote Support Module</h3>
        <p className="text-sm text-white/30 mt-1 max-w-md">
          Remote desktop access, session recording, and ticketing integration.
        </p>
      </GlassPanel>
    </div>
  );
