...
function renderPasswordReset(data: PasswordResetTemplateData): RenderedTransactionalEmail {
...
function renderEmailVerification(data: EmailVerificationTemplateData): RenderedTransactionalEmail {
...
function renderSecurityNotification(data: SecurityNotificationTemplateData): RenderedTransactionalEmail {
...
export function renderTransactionalEmail(
  ...
  switch (templateId) {
    ...
    case 'email-verification':
      return renderEmailVerification(data as EmailVerificationTemplateData);
    case 'security-notification':
      return renderSecurityNotification(data as SecurityNotificationTemplateData);
    default:
      throw new Error(`Unsupported template ID: "${templateId}"`);
  }
}

export const SUPPORTED_TEMPLATE_IDS: ReadonlySet<TransactionalEmailTemplateId> = new Set([
  'password-reset',
  'email-verification',
